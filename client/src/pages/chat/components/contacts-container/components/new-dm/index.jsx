            ...
            <TooltipTrigger>
              <FaPlus
                className="text-neutral-400 font-light text-opacity-90
                              text-sm hover:text-neutral-100 cursor-pointer transition-all duration-300"
            ...
            {searchedContacts.length <= 0 && (
              <div
                className="flex-1 md:flex
                      md:mt-0 flex-col justify-center items-center duration-1000 transition-all sm:mt-3"
              >
                <Lottie
                ...
                <div className="text-opacity-80 text-white flex flex-col items-center mt-5 lg:text-2xl text-xl transition-all duration-300 text-center ">
                  <h3 className="poppins-medium lg:mb-0 mb-4">
